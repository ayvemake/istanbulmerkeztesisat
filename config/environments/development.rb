...
Rails.application.configure do
  ...
  # Configuration des assets en développement
  config.assets.debug = true
  config.assets.compile = true
  config.assets.digest = false
  config.assets.check_precompiled_asset = false
  
  # Permettre le rechargement des assets
  config.assets.quiet = true

  # Configuration spécifique pour Propshaft
  config.assets.compile = true
  config.assets.digest = false
  ...
  # Permettre les connexions depuis n'importe quelle IP en développement
  config.hosts.clear
  # ou spécifiquement pour votre réseau local
  # config.hosts << /[a-z0-9]+\.192\.168\.0\.0\/16/
